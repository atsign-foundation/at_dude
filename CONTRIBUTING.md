...
1. Fork in GitHub https://github.com/atsign-foundation/at_dude
2. Clone *your forked repository* (e.g., `git clone git@github.com:yourname/at_dude`)
3. Set your remotes as follows:

   ```sh
   cd at_dude
   git remote add upstream git@github.com:atsign-foundation/at_dude.git
   ...
   ```text
   origin  git@github.com:yourname/at_dude.git (fetch)
   origin  git@github.com:yourname/at_dude.git (push)
   upstream        git@github.com:atsign-foundation/at_dude.git (fetch)
